...
.to(closeTriggerLeft, 0.8, {
  x: "-=300px", y: "+=300px", ease: Power4.easeOut
}, "preClose")
.to(closeTriggerRight, 0.8, {
  x: "+=300px", y: "+=300px", delay: 0.2, ease: Power4.easeOut
}, "preClose");
...
tlClose.add("close")
  .to(menuTop, 0.2, {
  backgroundColor: "#b3b3bb", ease: Power4.easeInOut, onComplete: function() {
    logo.css('z-index','26');
...
.to(menuMiddle, 0.2, {
  backgroundColor: "#b3b3bb", ease: Power4.easeInOut
}, "close") 
.to(menuBottom, 0.2, {
  backgroundColor: "#b3b3bb", ease: Power4.easeInOut
}, "close")
...
.to(menuBottom, 0.8, {
  ...
  ease: Power4.easeInOut,
  onComplete: function() {
    menuTop.css('background-color','#0a0a0a');
    menuMiddle.css('background-color','#0a0a0a');
    menuBottom.css('background-color','#0a0a0a');
  }
}, "close", "+=0.2")
.to(closeTriggerLeft, 0.2, {
  x: "+=300px", y: "-=300px", ease: Power4.easeIn
}, "close")
.to(closeTriggerRight, 0.2, {
  x: "-=300px", y: "-=300px", delay: 0.1, ease: Power4.easeIn
}, "close")
.to(openTriggerTop, 1, {
